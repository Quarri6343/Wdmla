...
/**
 * Provides essential information to {@link com.gtnewhorizons.wdmla.api.provider.IWDMlaProvider} for easy access to game
 * object without accessing internal engine.
 */
public interface Accessor {
    ...
    /**
     * @return the NBT data written in
     *         {@link com.gtnewhorizons.wdmla.api.provider.IServerDataProvider#appendServerData(NBTTagCompound, Accessor)}
     */
    @NotNull
    ...
    /**
     * Change from Waila: "Show Details" is no longer bound to player sneaking. All provider requires details to be
     * shown must check this condition.
     * 
