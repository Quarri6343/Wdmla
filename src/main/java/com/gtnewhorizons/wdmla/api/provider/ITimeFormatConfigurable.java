 ...
 * The config loader will mark the provider requires time formatter settings, then adds config entry to
 * {@link com.gtnewhorizons.wdmla.gui.ModsMenuScreenConfig}.<br>
