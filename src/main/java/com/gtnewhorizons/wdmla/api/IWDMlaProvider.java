...
public interface IWDMlaProvider {
    ...
    /**
     * Affects the registration and display order showing in the tooltip. Leave this to default if you want to show normal tooltip.
     * <p>
     ...
     * <p>
     * Registration of Default component such as item name occurs on -10000, and Registration of Harvestability occurs on -8000.
     * You can add your own default component between them.
     */
