...
public enum FallingBlockHeaderProvider implements IEntityComponentProvider {
    ...
    public void appendTooltip(ITooltip tooltip, EntityAccessor accessor) {
        if(accessor.getEntity() instanceof EntityFallingBlock falling) {
            ...
            ThemeHelper.INSTANCE.overrideEntityTooltipTitle(tooltip,
                    String.format(LangUtil.translateG("hud.msg.wdmla.entity.falling"), DisplayUtil.itemDisplayNameShort(itemForm)));
        }
    }
