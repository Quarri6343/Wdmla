...
public class RedstoneStateProvider implements IBlockComponentProvider {
    ...
    public void appendTooltip(ITooltip tooltip, BlockAccessor accessor, IPluginConfig config) {
        ...
        if (block == Blocks.lever) {
            ...
            tooltip.child(
                    new HPanelComponent()
                            .text(String.format("%s: ", LangUtil.translateG("hud.msg.delay")))
                            .child(ThemeHelper.INSTANCE.info(String.format("%s%s", tick,
                                    (tick == 1 ? LangUtil.translateG("hud.msg.tick") : LangUtil.translateG("hud.msg.ticks")))))
            );
        }
            ...
            tooltip.child(
                    new HPanelComponent()
                            .text(String.format("%s: ", LangUtil.translateG("hud.msg.mode")))
