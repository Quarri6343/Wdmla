...
public class LiveEditGuiConfigEntries extends GuiConfigEntries{
    ...
    public LiveEditGuiConfigEntries(GuiConfig parent, Minecraft mc) {
        ...
        for (int i = 0; i < listEntries.size(); i++) {
            if(listEntries.get(i) instanceof CategoryEntry categoryEntry) {
                listEntries.set(i, new LiveEditCategoryEntry(this.owningScreen, this, categoryEntry.getConfigElement()));
            }
        }
    }
    ...
    public static class LiveEditCategoryEntry extends GuiConfigEntries.CategoryEntry {
        ...
        public LiveEditCategoryEntry(GuiConfig owningScreen, GuiConfigEntries owningEntryList, IConfigElement configElement) {
        ...
        protected GuiScreen buildChildScreen() {
            return new LiveEditGuiConfig(this.owningScreen, this.configElement.getChildElements(), this.owningScreen.modID,
