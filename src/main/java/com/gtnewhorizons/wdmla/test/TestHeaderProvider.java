...
public class TestHeaderProvider implements IComponentProvider<BlockAccessor> {
    ...
    public void appendTooltip(ITooltip tooltip, BlockAccessor accessor) {
        ...
        tooltip.replaceChildWithTag(Identifiers.ITEM_NAME, new TextComponent(WHITE + "Furnace").tag(Identifiers.ITEM_NAME));
        tooltip.replaceChildWithTag(Identifiers.MOD_NAME, new TextComponent(BLUE + ITALIC + "WDMla").tag(Identifiers.MOD_NAME));
    }
}
